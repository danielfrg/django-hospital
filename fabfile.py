...
env.project_name = 'django_hospital'
env.repository = 'git@github.com:lincolnloop/django_hospital.git'
...
def dev():
    ...
    """
    server = 'django_hospital.dev.lincolnloop.com'
    env.roledefs = {
        'web': [server],
        'db': [server],
    }
