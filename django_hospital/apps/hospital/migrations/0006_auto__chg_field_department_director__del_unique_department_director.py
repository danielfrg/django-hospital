...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Department', fields ['director']
        db.delete_unique(u'hospital_department', ['director_id'])


        # Changing field 'Department.director'
        db.alter_column(u'hospital_department', 'director_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Department.director'
        db.alter_column(u'hospital_department', 'director_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'Department', fields ['director']
        db.create_unique(u'hospital_department', ['director_id'])
