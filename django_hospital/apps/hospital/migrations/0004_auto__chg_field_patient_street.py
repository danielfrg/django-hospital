...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.street'
        db.alter_column(u'hospital_patient', 'street', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Patient.street'
        db.alter_column(u'hospital_patient', 'street', self.gf('django.db.models.fields.CharField')(max_length=30))
