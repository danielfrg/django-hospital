...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Nurse', fields ['specialty']
        db.delete_unique(u'hospital_nurse', ['specialty_id'])


        # Changing field 'Nurse.specialty'
        db.alter_column(u'hospital_nurse', 'specialty_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hospital.NurseSpeciality']))

    def backwards(self, orm):

        # Changing field 'Nurse.specialty'
        db.alter_column(u'hospital_nurse', 'specialty_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['hospital.NurseSpeciality'], unique=True))
        # Adding unique constraint on 'Nurse', fields ['specialty']
        db.create_unique(u'hospital_nurse', ['specialty_id'])
    ...
    models = {
        ...
        u'hospital.department': {
            ...
            'director': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'hospital.nurse': {
            ...
            'specialty': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['hospital.NurseSpeciality']"}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True', 'primary_key': 'True'})
        },
