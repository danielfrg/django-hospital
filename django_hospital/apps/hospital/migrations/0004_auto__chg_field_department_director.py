...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Department.director'
        raise RuntimeError("Cannot reverse this migration. 'Department.director' and its values cannot be restored.")
    ...
    models = {
        ...
        u'hospital.department': {
            ...
            'director': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
