...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MedsPrice.date'
        db.add_column(u'hospital_medsprice', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 22, 0, 0)),
                      keep_default=False)

        # Adding field 'MedsPrice.medicament'
        db.add_column(u'hospital_medsprice', 'medicament',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=12, to=orm['hospital.Medicament']),
                      keep_default=False)

        # Adding field 'MedsPrice.price'
        db.add_column(u'hospital_medsprice', 'price',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Medicament.description'
        db.add_column(u'hospital_medicament', 'description',
                      self.gf('django.db.models.fields.CharField')(default=':)', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MedsPrice.date'
        db.delete_column(u'hospital_medsprice', 'date')

        # Deleting field 'MedsPrice.medicament'
        db.delete_column(u'hospital_medsprice', 'medicament_id')

        # Deleting field 'MedsPrice.price'
        db.delete_column(u'hospital_medsprice', 'price')

        # Deleting field 'Medicament.description'
        db.delete_column(u'hospital_medicament', 'description')
    ...
    models = {
        ...
        u'hospital.medsprice': {
            'Meta': {'object_name': 'MedsPrice'},
