...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MedsPrice'
        db.create_table(u'hospital_medsprice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'hospital', ['MedsPrice'])


        # Changing field 'Visit.date'
        db.alter_column(u'hospital_visit', 'date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting model 'MedsPrice'
        db.delete_table(u'hospital_medsprice')


        # Changing field 'Visit.date'
        db.alter_column(u'hospital_visit', 'date', self.gf('django.db.models.fields.DateField')())
