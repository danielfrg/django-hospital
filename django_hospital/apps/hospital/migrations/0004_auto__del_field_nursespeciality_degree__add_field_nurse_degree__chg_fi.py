...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NurseSpeciality.degree'
        db.delete_column(u'hospital_nursespeciality', 'degree')

        # Adding field 'Nurse.degree'
        db.add_column(u'hospital_nurse', 'degree',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'NurseSpeciality.degree'
        raise RuntimeError("Cannot reverse this migration. 'NurseSpeciality.degree' and its values cannot be restored.")
        # Deleting field 'Nurse.degree'
        db.delete_column(u'hospital_nurse', 'degree')
